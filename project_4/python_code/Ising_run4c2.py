...
ax1.plot(trials[Temp+1:], sampled_energies[1:,0], 'r--', label= 'random')
ax1.plot(trials[Temp+1:], o_sampled_energies[1:,0], 'b--', label = 'ordered')
ax1.legend()
ax1.set_ylabel(r'$\langle E \rangle$', fontsize = 10)
ax1.grid()
ax2 = plt.subplot(212)
ax2.plot(trials[Temp+1:], sampled_absmagn[1:,0], 'r--', label = 'random')
ax2.plot(trials[Temp+1:], o_sampled_absmagn[1:,0], 'b--', label = 'ordered')
ax2.legend()
