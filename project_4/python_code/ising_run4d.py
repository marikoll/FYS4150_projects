...
plt.legend()
#plt.axis([-1.3, -1.2])
plt.title('Normalized energy distribution with T = 2.4\nMC-cutoff: {}%'.format(p[1]*100))
...
plt.legend()
#plt.axis([-1.3, -1.2])
plt.title('Normalized energy distribution with T = 1.0\nMC-cutoff: {}%'.format(p[0]*100))
